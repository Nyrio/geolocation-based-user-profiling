...
*/
  ...
  public:
    ...
    */
    vector<Cluster*> run(float epsilon,int minPts);
  private:
    /**
    ...
    */
    void cleanTree();
    /**
    * gets the neighbours of point, within epsilon and with a minimum of minPts neighbours
    */
    ...
    */
    ClusterWrapper* getClusterJoinable(Cluster& cluster,vector<services::ClusterWrapper*>& clusters,float epsilon);
